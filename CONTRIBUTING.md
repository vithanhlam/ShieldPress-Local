...
1. Fork the repository: https://github.com/vithanhlam/ShieldPress-Local
2. Create a branch from `main` for your change.
3. Make focused commits with a clear English message.
4. Run tests locally:
   ```bash
   npm test
   ```
5. Open a pull request against `main` and describe the problem, the change, and how you tested it.
