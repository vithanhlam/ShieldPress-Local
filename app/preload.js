...
contextBridge.exposeInMainWorld("api", {
  ...
  s3GetBuckets: () => ipcRenderer.invoke("s3-get-buckets"),
  s3OpenWindow: (id) => ipcRenderer.invoke("s3-open-window", id),
  s3SaveBucket: (d) => ipcRenderer.invoke("s3-save-bucket", d),
  s3DeleteBucket: (id) => ipcRenderer.invoke("s3-delete-bucket", id),
  s3TestBucket: (id) => ipcRenderer.invoke("s3-test-bucket", id),
  s3ListObjects: (id, prefix) => ipcRenderer.invoke("s3-list-objects", { id, prefix }),
  s3DeleteObject: (id, key) => ipcRenderer.invoke("s3-delete-object", { id, key }),
  s3DownloadObject: (id, key, localPath) => ipcRenderer.invoke("s3-download-object", { id, key, localPath }),
  s3DownloadPrefix: (id, prefix, localPath, opts) => ipcRenderer.invoke("s3-download-prefix", { id, prefix, localPath, opts }),
  s3UploadPaths: (id, items, opts) => ipcRenderer.invoke("s3-upload-paths", { id, items, opts }),
  s3Upload: (id, opts) => ipcRenderer.invoke("s3-upload", { id, opts }),
  s3Download: (id, opts) => ipcRenderer.invoke("s3-download", { id, opts }),
